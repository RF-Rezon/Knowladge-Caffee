...
const Nav = () => {
    return (
        <div className='max-w-7xl mx-auto p-3 py-5 mb-4 cursor-default'>
            <div className='flex items-center justify-between'>
                <div className='text-left text-2xl md:text-4xl  font-bold text-gray-800'><h2>Knowledge Cafe</h2></div>
