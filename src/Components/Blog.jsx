  ...
  return (
    <div className="cursor-default">
      <div className="rounded-md bg-gray-100 p-5 drop-shadow-xl mb-8">
          <p className="font-bold text-2xl md:text-4xl my-1 mb-5 pt-3">Props vs State</p>
          <p className="font-semibold text-zinc-800 text-lg md:text-xl my-2">
      ...
      <div  className="rounded-md bg-gray-100 p-5 drop-shadow-xl mb-8">
          <p className="font-bold text-2xl md:text-4xl my-1 mb-5 pt-3">How does useState work?</p>
          <p className="font-semibold text-zinc-800 text-lg md:text-xl my-2">
      ...
      <div  className="rounded-md bg-gray-100 p-5 drop-shadow-xl mb-8">
          <p className="font-bold text-2xl md:text-4xl my-1 mb-5 pt-3">What is the purpose of useEffect other than fetching data?</p>
          <p className="font-semibold text-zinc-800 text-lg md:text-xl my-2">
      ...
      <div  className="rounded-md bg-gray-100 p-5 drop-shadow-xl mb-12">
          <p className="font-bold text-2xl md:text-4xl my-1 mb-5 pt-3">How Does React work?</p>
          <p className="font-semibold text-zinc-800 text-lg md:text-xl my-2">
